...
app.controller('InfoCtrl',[function(){
  ...
  self.projects = [
  { name: 'refbot', description: 'An Angular app which takes image URLs and displays them. Designed with artists in mind who need a single place to place their reference photos without the hassle of messing with multiple windows.', contribution: 'Front End, Site Design, UX', tech: 'HTML, CSS, AngularJS', link:'../../projects/refbot/index.html', repoLink: 'https://github.com/descartez/refbot'},
