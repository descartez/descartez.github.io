...
app.controller('InfoCtrl',[function(){
  ...
  self.projects = [
    ...
    { name: 'algorithm.ic', description: 'A collection of popular algorithms used in coding interviews, and their solutions.', contribution: 'Content', tech: 'n/a', link:'https://github.com/descartez/algorithm.ic', repoLink: 'github.com/descartez/algorithm.ic'},
  ];
